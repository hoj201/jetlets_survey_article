...
\dm{I have four remarks about this: (i) AK98 Thm 5.5 looks, to me, like a statement of Kelvin's theorem, but it doesn't mention momentum maps etc...? (ii) I believe that in the limit as $\varepsilon$ goes to zero, the vector field $w$ should blow up in strength (ArnoldKhesin talk about unit flux through a transverse section to the curve), and (iii) the integration region in the first integral above should probably be $\mathbb{R}^n$, rather than $\gamma_0$? Finally, (iv), what are the pairings $\langle ., .\rangle$ in these integrals...? They probably aren't dual pairings..?} Therefore, conservation of $J_{\rm conv}$ leads to conservation of circulation. 

A more rigorous correspondence is developed in \cite{HolmMarsdenRatiu1998}
using so-called currents.
