...
\begin{abstract}
  We review the role of weak dual pairs in mechanics and use them
  to derive particle-like solutions to regularized incompressible
  fluid systems.
  These weak dual pairs result from the action of diffeomorphisms on point
  particles (essentially by moving the points).
  We then augment our weak dual pairs by considering the action of diffeomorphisms
  on Taylor series, also known as \emph{jets}.
  The augmented weak dual pairs induce a hierarchy of particle-like solutions
...
Similar constructions will be crucial in later sections, when constructing the right leg of a weak dual pair for the higher levels in the hierarchy of particle-like solutions.
