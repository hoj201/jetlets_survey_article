...
%Furthermore, even if the differential of the Hamiltonian is in the right space, it is not apriori clear that the resulting vector-field is smooth enough for solutions to exist.
