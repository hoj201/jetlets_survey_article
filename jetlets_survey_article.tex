...
Their heuristic argument goes as follows.
...
and such that the limit as $w = \lim_{\varepsilon \to 0} w_\varepsilon$ is the discontinuous map
\begin{equation*}
  w(x) = \begin{cases}
  ...
  \end{cases}
\end{equation*}
Assuming $\epsilon$ is small we find
...
\begin{align*}
  ...
  &\approx \oint \langle \dot{\varphi}(\gamma_0(s) , \textrm{D}\varphi(\gamma_0(s))\cdot \gamma_0'(s) \rangle \,\textrm{d} s \\
...
It is in this sense that conservation of circulation follows from the conservation of $J_{\rm conv}$.
