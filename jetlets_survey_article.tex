...
\begin{enumerate}
  ...
  \item We compute a nested sequence of conserved quantities at 
    ...
    of circulation.
  \item We numerically compute some particle-like solutions at the zeroth and first levels in the hierarchy.  We will observe a form of cascade in which interactions of solutions at the $k^{\rm th}$ level tend asymptotically in time toward solutions at the $(k+1)^{\rm th}$ level.
\end{enumerate}
