...
\title{Dual pairs and guaged-particle methods for ideal incompressible fluid models in $n \geq 2$ dimensions}
...
\begin{figure}[ht]
  ...
  \caption{Contour plots of the reduced
    ...
    $p_\varphi = 0.2$. The red line shows the positive asymptotic
...
\end{prop}
  ...
  \begin{thm}[example 2.2 of \cite{GayBalmazVizman2012}] \label{thm:commuting_actions}
    Denote the canonical symplectic form on $T^*Q$ by $\omega$.
  ...
  \begin{proof}
    ...
    Recall that $J_1$ the definition of ``momentum map'' means
