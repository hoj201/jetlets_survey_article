...
\end{align}
where we used \eqref{Moma_right} in the final step. In particular, the restricted momentum map $\left. J_{\rm conv} \right|_S$ is invariant under the right action of $\SDiff(\R^n)$,
