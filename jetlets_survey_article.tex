...
\begin{align}
  \langle J_\text{conv}(\varphi,p_\varphi) , w \rangle = \langle p_\varphi , T\varphi \cdot w \rangle \label{eq:circulation}
\end{align}
...
our particle models is a shadow of the conservation of $J_\text{conv}$ in~\eqref{eq:circulation}.
